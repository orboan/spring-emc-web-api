...
//Escolta els Rest Controller (responsables de respondre a les peticions Http)
...
public class ControllerExceptionHandler {
	...
	public ErrorMessage globalException(ResourceNotFoundException ex, WebRequest request) {
